	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加故障" _href="problem_add.html" onclick="problem_add('添加故障','problem_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加故障信息</a>
				</span>
					...
					<tbody>
						<tr class="text-c">
							...
							<td class="f-14 td-manage">
								<a style="text-decoration:none" class="ml-5" onclick="problem_edit('故障编辑','problem_add.html','10001')" href="javascript:;" title="故障-编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a style="text-decoration:none" class="ml-5" onclick="problem_del(this,'10001')" href="javascript:;" title="故障-删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</td>
						</tr>
						<tr class="text-c">
							<td><input type="checkbox" value="" name=""/></td>
...
/*故障-添加*/
function problem_add(title,url,w,h){
...
/*故障-编辑*/
function problem_edit(title,url,id,w,h){
	var index = layer.open({
		type: 2,
		title: title,
		content: url
